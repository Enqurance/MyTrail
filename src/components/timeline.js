...
import {CalendarMonth, Flight, Home, Quiz, Science, School} from "@mui/icons-material";
import {
    yearText, dateText, infoText
} from '../components/timeline.module.css'
import Grid from "@mui/material/Grid";
import Stack from '@mui/material/Stack';
import { blue, green, orange, yellow, purple, cyan } from '@mui/material/colors';
            ...
            <Grid item xs={12}>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        <Flight fontSize={"large"} sx={{color: blue[800]}}></Flight>
                        <Grid container>
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#1664C0'}}>11.3 - 11.12</Typography>
                            </Grid>
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#1664C0'}}>I visited Japan🇯🇵 With Dr. Guo</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#2F7D32'}}>I visited Yantai City🍎, Shandong</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2} paddingTop={3}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#2F7D32'}}>I was at Home🏠 for National Holiday</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#EF6C00'}}>I visited Changsha City🌶️, Hunan</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2} paddingTop={3}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#EF6C00'}}>I visited Shaanxi🍜 and took the GRE test</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#FBC02D'}}>I was doing Internship at HKU🧐</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#7B1EA2'}}>I arrived at HKU for an Internship🇭🇰</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#00BCD4'}}>I visited Mt. Changbai⛰️, Jilin</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
                ...
                <Stack direction="row" spacing={2} paddingLeft={1.5}>
                    ...
                    <Stack direction="row" spacing={2}>
                        ...
                        <Grid container>
                            ...
                            <Grid item xs={12}>
                                <Typography className={infoText} style={{color: '#81C784'}}>I went back school🏫️ after staying 3 months at home</Typography>
                            </Grid>
                        </Grid>
                    </Stack>
                </Stack>
